...
STORIES = [
    ...
    },
    {
        ...
        "sections": [
            ...
            ("ศิวรา คาเฟ่ในระบบเรื่องเล่า", "ศิวรา คาเฟ่เป็นผู้จัดทำตะกั่วป่า 101 และอยู่ในเมนูร้านอาหารของเว็บไซต์เพื่อให้ผู้อ่านแยกบทบาทผู้จัดทำออกจากข้อมูลประวัติศาสตร์ได้ชัดเจน · ข้อมูลการเปิดบริการและเมนูให้ตรวจจากเว็บไซต์ของร้านโดยตรง"),
        ],
    },
]
