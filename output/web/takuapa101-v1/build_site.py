...
nav=[('places','สถานที่'),('map','แผนที่'),('traditions','ประเพณี'),('eat','กินและของฝาก'),('routes','เส้นทางเดิน'),('about','เกี่ยวกับ')]
...
def page(path,title,desc,body,record=None):
 ...
 meta={"og:title":title,"og:description":desc,"og:url":canonical,"og:type":"website","og:image":og_image,"og:locale":"th_TH","og:site_name":"????????? 101","twitter:card":"summary_large_image","twitter:image":og_image}
 ...
 html=f'''<!doctype html><html lang="th"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>{esc(title)} · ตะกั่วป่า 101</title><meta name="description" content="{esc(desc)}"><meta name="robots" content="index,follow,max-image-preview:large">{social}<meta name="generator" content="????????? 101"><link rel="canonical" href="{esc(canonical)}"><link rel="preload" href="/assets/NotoSerifThai.woff2" as="font" type="font/woff2" crossorigin><link rel="preload" href="/assets/IBMPlexSansThaiLooped-Regular.woff2" as="font" type="font/woff2" crossorigin><link rel="stylesheet" href="/assets/site.css"><script type="application/ld+json">{json.dumps(schema,ensure_ascii=False).replace('</','<\\/')}</script><script src="/assets/site.js" defer></script></head><body><a class="skip" href="#main">ข้ามไปเนื้อหา</a><header class="nav"><a class="brand" href="/">ตะกั่วป่า <span>101</span></a><nav aria-label="เมนูหลัก">{menu}</nav></header><main id="main">{body}</main><footer><a class="brand" href="/">ตะกั่วป่า <span>101</span></a><p>เมืองเก่า เรื่องเล่า และผู้คน</p><div><a href="https://siwaracafe.com/">จัดทำโดยบ้านศิวรา ตะกั่วป่า</a><a href="{SOURCE}">แผ่นพับต้นทาง ↗</a></div></footer></body></html>'''
